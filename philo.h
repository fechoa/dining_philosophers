...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/09 12:39:26 by gkelsie           #+#    #+#             */
/*   Updated: 2021/11/13 13:21:02 by gkelsie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_philo
{
	...
	int							count_eat;
	int							stop;
	struct s_values_input		*values_input;
...
int			check_die(t_program *data, int i);
void		*check_meal(t_program *data);
